export function mount(container) {
  ...
  try { if (window.HiMathStats) window.HiMathStats.startPage('games'); } catch (e) {}
  ...
  function spawnApple() { 
      ...
      apples.push({ 
          lane: randomLane, 
          y: -40, 
          speed: 0.8 + Math.random()*0.4 + (score/50), // Tăng tốc độ theo điểm
          value: value 
      }); 
  }
  ...
  container._hungtaoCleanup = () => {
    ...
    try { if (window.HiMathStats) window.HiMathStats.endPage('games'); } catch (e) {}
