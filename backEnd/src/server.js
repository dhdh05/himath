...
console.log("Auth Routes:", authRoutes);     // Phải là [Function: router]
console.log("Game Routes:", gameRoutes);     // Phải là [Function: router]
console.log("Parent Routes:", parentRoutes); // Phải là [Function: router]
console.log("Stats Routes:", statsRoutes);   // Phải là [Function: router]
dotenv.config();
...
// //ham nay de cho phep frontend goi api
// const express = require('express');
